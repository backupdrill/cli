...
const ENV_KEYS = [
  ...
  // Storage 源三项"给一缺二"会让 loadConfig 抛错:开发者 shell 里残留半份
  // 这些变量时,不隔离会与被测逻辑无关地假失败
  ...
  "BACKUPDRILL_SUPABASE_STORAGE_BUCKETS",
];
